...
Play online [here](https://jcarr.ca/IsoMAZEtric).

## Description
Technically the project is not isometric, but rather dimetric: a slightly different type of axonometric projection.

All the art used for this project was generated by code, rather than "hand-crafted". 
The style is very minimalist, and tries to stay as mathematically pure/ridgid as possible.
- The sprites used for this project was procedurally generated by my project [ProceduralPixelArt](https://github.com/jlcarr/ProceduralPixelArt).
- The meshes used for this project were generated in my project [BasicMeshes](https://github.com/jlcarr/BasicMeshes).
- The music and sound effects used for this project were generated in my project [MusicFromScratch](https://github.com/jlcarr/MusicFromScratch).
...
- Jitter
   ...
   - There is audio jitter in the HTML5 export.
      - This is a known issue, that is mostly due to threading: the threaded export solves it, but will work on fewer browsers.
      - Furthermore on Chrome the audio does not start until the game is clicked because of Chrome's auto-play policy.
